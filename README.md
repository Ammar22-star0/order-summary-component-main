...
- Solution URL: [Add solution URL here](https://github.com/Ammar22-star0/order-summary-component-main.git)
...
```html
<img src="images/pattern-background-desktop.svg" alt="" /><!-- alt="" -->
```
